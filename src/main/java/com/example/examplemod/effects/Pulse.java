...
public class Pulse extends MobEffect {
    ...
    static void createParticleBeam(Level level, float x_f, float y_f, float z_f) {
        ...
        ParticleAreaSpawner areaParticle = new ParticleAreaSpawner(level, particleType2, -5, 8, (float) (1));
    ...
    static void createRandomLine(Level level, float x_f, float y_f, float z_f) {
        ...
        ParticleAreaSpawner areaParticle = new ParticleAreaSpawner(level, particleType2, 0, 10, (float) (1));
        double times=3;
